...
--веса и страны отгрузки), которые должны быть отгружены в страны имя которых начинается с 'N', 
...
SELECT employee_id, last_name, first_name, home_phone, region
FROM employees
...
--9. Выбрать такие страны в которых "зарегистрированы" одновременно заказчики и поставщики, но при этом в них
--не "зарегистрированы" работники
